...
// Debug
ini_set('display_errors', ERR_DISPLAY ? 'On' : 'Off');
ini_set('log_errors', ERR_LOG ? 'On' : 'Off');
ini_set('error_log', DIR_LOGS . ERR_FILENAME);
...
// Helper
require_once(modification(DIR_SYSTEM . 'helper/bbcode.php'));
